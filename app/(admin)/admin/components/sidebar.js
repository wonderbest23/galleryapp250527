...
export default function Sidebar({ onItemClick }) {
  const menuItems = [
    ...
    { icon: "lucide:gift", label: "리워드샵관리", href: "/admin/reward-shop" },
    { icon: "lucide:pen-tool", label: "기자단관리", href: "/admin/journalist" },
    ...
    { icon: "lucide:bot", label: "AI스케줄", href: "/admin/community/ai-manager" },
    { icon: "lucide:file-text", label: "신고관리", href: "/reports" },
    ...
    { icon: "lucide:star", label: "커스텀리뷰승인", href: "/admin/custom-reviews" },
    { icon: "lucide:shield-alert", label: "리뷰어뷰징모니터링", href: "/admin/review-monitoring" },
    { icon: "lucide:coins", label: "포인트적립검토", href: "/admin/point-review" },
    { icon: "lucide:pen-tool", label: "기자단체험관리", href: "/admin/journalist-experience" },
