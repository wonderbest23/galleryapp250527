          ...
          {magazines[0] && (
            ...
            >
              {magazines[0].photo?.[0]?.url && (
                <Image
                  src={
                    getSupabaseImageUrl(magazines[0].photo?.[0]?.url, { width: 400, quality: 70 }) || "/images/noimage.jpg"
                  }
                  alt="대표 이미지"
                  width={400}
                  height={256}
                    ...
                    <div className="flex flex-row items-center gap-4 w-full">
                      ...
                      {item.photo?.[0]?.url && (
                        <Image
                          ...
                          src={
                            getSupabaseImageUrl(item.photo?.[0]?.url, { width: 96, quality: 70 }) || "/images/noimage.jpg"
                          }
                          width={96}
                          height={96}
                          loading="lazy"
