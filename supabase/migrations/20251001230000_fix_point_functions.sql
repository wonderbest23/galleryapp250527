...
grant execute on function get_locked_points(uuid) to authenticated;
grant execute on function unlock_points_after_48h() to authenticated;
grant execute on function update_user_grade(uuid) to authenticated;
